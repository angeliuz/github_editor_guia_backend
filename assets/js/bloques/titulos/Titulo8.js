class Titulo8 extends Titulo {
  ...
  render(){
    ...
    html+='    <div data-texto="texto" class="text-input rounded rounded-3 d-inline-block fs-6 f-nunito fw-700 py-1 px-2 color-white bgc-red">';
