class Listado13 extends Listado {
  ...
  renderOpcion(opcion) {
    return (
      '<li class="color-primary opcion pt-3"><div class="handle"><i class="fas fa-th"></i></div><span class="color-hardDark"><div class="editable li-editable" contenteditable="true" data-docid="' +
      opcion.doc_id +
      '">' +
      opcion.texto +
