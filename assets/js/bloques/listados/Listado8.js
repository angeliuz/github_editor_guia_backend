class Listado8 extends Listado {
  ...
  renderOpcion(opcion) {
    return (
      '<li class="opcion color-primary fw-600"><div class="handle"><i class="fas fa-th"></i></div><span class="color-hardDark fw-300"><div class="editable li-editable" contenteditable="true" data-docid="' +
      opcion.doc_id +
      '">' +
      opcion.texto +
