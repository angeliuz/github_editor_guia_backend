class Imagen3 extends Imagen {
  
  id = 'im_003';
  border = '';
  data = {
        nombre:'Imagen con bajada borde',
        data:{
  ...
  render(){
    ...
    html+='                 <img class="border border border-2 border-dark img-columna" src="'+data.ruta+'" width="'+data.porcentaje+'%">';
    html+='</div>';
  ...
  renderMenu(){
    ...
    html+='<div class="pt-2 d-flex '+data.alineacion+'" >';
    html+='                 <img class="border border border-2 border-dark " src="'+data.ruta+'" width="'+data.porcentaje+'%">';
    html+='</div>';
