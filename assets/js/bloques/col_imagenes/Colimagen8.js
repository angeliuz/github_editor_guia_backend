class Colimagen8 extends Imagen {
  
  id = 'ci_008';
  border = 'border-end border-color-lightDark border-3 border-right-dashed';
  data = {
  ...
  render(){
    ...
    html+='      <div class="d-block ms-20 me-20 w-60 border border-3 rounded-p-10 border-color-lightDark">';
