class Colimagen4 extends Imagen {
  
  id = 'ci_004';
  border = '';
  data = {
        nombre:'Tres columnas texto linea',
        data:{
  ...
  renderColumna(data,i){
    ...
    html+='     <div data-texto="titulo" class=" text-input d-flex w-100 justify-content-center f-nunito fs-5 fw-400 color-hardDark">'+data.titulo+'</div>';
